      ...
      <div className="container1">
        <div className="d-flex align-center flex-column">
          ...
          <div className="col-L">
            ...
            <hr />
            <p>
            We apologize for the inconvenience. Our website is currently undergoing maintenance to enhance your experience. Please check back shortly.
            </p>
          </div>
          <div className="col-R">
            <svg x="0px" y="0px" viewBox="0 0 219.9 219.9" style={{}}>
              <g>
                <path
                  className="st0"
